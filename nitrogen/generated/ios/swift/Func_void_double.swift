...
/**
 * Wraps a Swift `(_ percent: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.inappupdates.bridge.swift

  private let closure: (_ percent: Double) -> Void

  public init(_ closure: @escaping (_ percent: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(percent: Double) -> Void {
    self.closure(percent)
  }

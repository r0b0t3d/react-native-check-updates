...
/**
 * Represents the JavaScript callback `(percent: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(percent: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @FastNative
  private external fun invoke_cxx(percent: Double): Unit
}

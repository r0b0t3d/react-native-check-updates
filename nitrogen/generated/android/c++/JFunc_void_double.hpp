...
namespace margelo::nitro::inappupdates {
  ...
  /**
   * Represents the Java/Kotlin callback `(percent: Double) -> Unit`.
  ...
  public:
     ...
     */
    void invoke(double percent) const {
      static const auto method = javaClassStatic()->getMethod<void(double /* percent */)>("invoke");
      method(self(), percent);
    }
  };
  ...
  public:
    static jni::local_ref<JFunc_void_double::javaobject> fromCpp(const std::function<void(double /* percent */)>& func) {
  ...
  public:
     ...
     */
    void invoke_cxx(double percent) {
      _func(percent);
    }

  public:
    [[nodiscard]]
    inline const std::function<void(double /* percent */)>& getFunction() const {
      return _func;
    }
  ...
  private:
    explicit JFunc_void_double_cxx(const std::function<void(double /* percent */)>& func): _func(func) { }
